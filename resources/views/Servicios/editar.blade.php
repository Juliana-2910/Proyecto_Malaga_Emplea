...
<div class="min-h-screen bg-gray-100 py-10">
    ...
    <div class="mx-auto max-w-4xl px-6">
        ...
        <div class="rounded-xl bg-white p-8 shadow">
            ...
            <form action="{{ route('servicios.update', $servicios->id) }}"
                method="POST">
                    ...
                    <select id="idCategoria"
                        ...
                        @foreach ($categorias as $categoria)
                            ...
                            <option value="{{ $categoria->id }}"
                                {{ old('idCategoria', $servicios->idCategoria) == $categoria->id ? 'selected' : '' }}>
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        id="nombre"
                        name="nombre"
                        value="{{ old('nombre', $servicios->nombre) }}"
                        class="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:border-[#4DB6E8] focus:outline-none focus:ring-1 focus:ring-[#4DB6E8]"
                ...
                <div class="mb-6">
                    ...
                    <textarea id="descripcion"
                            ...
                            rows="5"
                            class="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:border-[#4DB6E8] focus:outline-none focus:ring-1 focus:ring-[#4DB6E8]"
                            placeholder="Ingrese la descripción del servicio">{{ old('descripcion', $servicios->descripcion) }}</textarea>
