...
<div class="mx-auto max-w-5xl px-6">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500">
            Actualización de la información de la postulación
        </p>
    ...
    <div class="rounded-xl bg-white p-8 shadow">
        ...
        <form action="{{ route('postulacion.update', $postulacion->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="date"
                           name="fecha"
                           id="fecha"
                           value="{{ old('fecha', $postulacion->fecha) }}"
                ...
                <div>
                    ...
                    <select name="estado"
                        ...
                        <option value="Enviado"
                            {{ old('estado', $postulacion->estado) == 'Enviado' ? 'selected' : '' }}>
                            Enviado
                        </option>

                        <option value="Aceptado"
                            {{ old('estado', $postulacion->estado) == 'Aceptado' ? 'selected' : '' }}>
                            Aceptado
                        </option>

                        <option value="Rechazado"
                            {{ old('estado', $postulacion->estado) == 'Rechazado' ? 'selected' : '' }}>
                            Rechazado
                        </option>
                ...
                <div>
                    ...
                    @foreach ($usuarios as $usuario)
                        ...
                        <option value="{{ $usuario->id }}"
                            {{ $usuario->id == $postulacion->idUsuario ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    @foreach ($ofertas as $oferta)
                        ...
                        <option value="{{ $oferta->id }}"
                            {{ $oferta->id == $postulacion->idOferta ? 'selected' : '' }}>
                            {{ $oferta->titulo }}
                        </option>
